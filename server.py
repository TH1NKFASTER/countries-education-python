...
new_participant = IMO_participant.create(year=1984, country='USS', firstname='Andrei', lastname='Astrelin', total=42, rank=1, award='Gold_medal')
new_participant.save()
new_participant = IMO_participant.create(year=1984, country='USS', firstname='Konstantin', lastname='Ignatiev', total=42, rank=1, award='Gold_medal')
new_participant.save()
new_participant = IMO_participant.create(year=1984, country='USS', firstname='Leonid', lastname='Oridoroga', total=42, rank=1, award='Gold_medal')
new_participant.save()
new_participant = IMO_participant.create(year=1984, country='USA', firstname='David', lastname='Moews', total=42, rank=1, award='Gold_medal')
new_participant.save()
new_participant = IMO_participant.create(year=1984, country='USS', firstname='Fedor', lastname='Nazarov', total=41, rank=9, award='Gold_medal')
new_participant.save()
...
def add_participant():
    new_participant = IMO_participant.create(year=flask.request.args['year'], country=flask.request.args['country'], firstname=flask.request.args['firstname'], lastname=flask.request.args['lastname'],
                                             total=flask.request.args['total'], rank=flask.request.args['rank'], award=flask.request.args['award'])
    new_participant.save()
